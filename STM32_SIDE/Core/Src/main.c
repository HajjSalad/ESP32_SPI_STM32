...
uint8_t tx_buffer[] = "Response from STM32 Slave";
...
void HAL_SPI_TxRxCpltCallback(SPI_HandleTypeDef *hspi) {
    if (hspi->Instance == SPI1) {
		...
		// Re-initiate SPI communication
		HAL_SPI_TransmitReceive_IT(hspi, tx_buffer, rx_buffer, sizeof(tx_buffer));
    }
}
...
int main(void)
{
  ...
  // Start SPI slave receive/transmit
